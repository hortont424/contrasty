...
@logCall
def breathingCorrection(image, focalDistance, minFocalDistance, lens="Nikon-50mm-f1.8"):
    ...
    cropSize = tuple([int(round(dim * (1.0 / computeScaleFactor(minFocalDistance, "Nikon-50mm-f1.8")))) for dim in image.size])
